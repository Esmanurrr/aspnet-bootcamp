...
namespace ArabaKayitFormu
{
    ...
    {
        string connectionString = @"Data Source=.\sqlexpress; Initial Catalog = BTKDatabase; Integrated Security = SSPI;";
        ...
        //sayfa yüklendiðinde ilk çalýþmasýný istediðimiz metod
